...
void bs3_debug_comm_cmd(struct bs3_debug_data * pbs3debug) 
{
    ...
    switch (pbs3debug->buff[0])
    {
        ...
        case 'h':
            ...
            bs3_debug_comm_send(pbs3debug, "                         example : >u 0400\n");
            ...
            bs3_debug_comm_send(pbs3debug, "                         example : >g 06F0\n");
            ...
            bs3_debug_comm_send(pbs3debug, "                         example : >t 10\n");
            ...
            bs3_debug_comm_send(pbs3debug, "                         example : >r w0 0FF0\n");
            bs3_debug_comm_send(pbs3debug, "                         example : >r Z 1\n");
            bs3_debug_comm_send(pbs3debug, "   e address value     : Set 'value' byte to address\n");
            bs3_debug_comm_send(pbs3debug, "                         example : >e 061F A5\n");
            bs3_debug_comm_send(pbs3debug, "   E address value     : Set 'value' word to address (little endian)\n");
            bs3_debug_comm_send(pbs3debug, "                         example : >E 0FF0 abF0\n");
            bs3_debug_comm_send(pbs3debug, "   d [address]         : Dump data at adress, or continue dump from previous dump address\n");
            bs3_debug_comm_send(pbs3debug, "                         example : >d 0000\n");
            bs3_debug_comm_send(pbs3debug, "   a address asmcode   : Assemble 'asmcode' at 'address'\n");
            bs3_debug_comm_send(pbs3debug, "                         asmcode must comply with BS3 assembler syntax\n");
            bs3_debug_comm_send(pbs3debug, "                         example : a 0400 jmp $40F\n");
            bs3_debug_comm_send(pbs3debug, "                         example : a 0400 DB 'a',0,$ff,-12,\"Hello\"\n");
