...
public class BS5MemoryCell_ccc_f_oooo_oooo_oooo extends BS5MemoryCell {
    ...
    protected BS5MemoryCell_ccc_f_oooo_oooo_oooo(BS5program prg, int addr, 
    ...
    public BS5MemoryCell_ccc_f_oooo_oooo_oooo setValue(int oooo_oooo_oooo) throws BS5Exception {
